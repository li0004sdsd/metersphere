export default {
  ...
  'system.config.page.themeTip': '平台主题色是指除了页面背景色之外的 botim 紫色系颜色',
  ...
  'system.config.page.loginPreviewTip': 'tips:默认为 botim 系统界面，支持自定义平台界面设置',
  ...
  'system.config.page.platformConfigTip': 'tips:默认为 botim 系统界面，支持自定义界面设置',
